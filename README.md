...
However, shelljs supported commands, where available, are much faster than both. Use this module where an equivalent shelljs supported command is unavailable.
